...
<body>
    ...
    <form action="results.php" method="post">
        ...
        <div id="action-form" class="genreform" method ="post">
        ...
        <div id="comedy-form" class="genreform" menthod="post">
            ...
            <label for="">thể loại</label>
            <input type="text" name="comedy_genre" id="comedy_genre">
            <label for="">năm sản xuất</label>
        ...
        <div id="documentary-form" class="genreform" menthod="post">
            ...
            <input type="text" name="documentary_genre" id="documentary_genre">
    ...
    <script>
        document.getElementById('genre').addEventListener('change', function() {
            document.querySelectorAll('.genreform').forEach(form => form.style.display = 'none');
